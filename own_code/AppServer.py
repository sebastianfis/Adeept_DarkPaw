...
if __name__ == '__main__':
    ...
    camera = Picamera2()
    camera.set_controls({"AwbEnable": False})#"AwbMode": controls.AwbModeEnum.Auto})
    camera.configure(camera.create_video_configuration(main={"size": (1280, 960)}, raw={'format': 'SGRBG10'}))
